...
class MultiCompiler():
    def __init__(self):
            ...
            self.label=t.Label(self.compilerwindow,text="IDE API GEEK",fg="black",bg="white",font=("times new roman",35,"italic")).place(x=150,y=10)
            ...
            self.run.add_command(label='Rodar  f5',command=self.runit)
            #adding sub menu 3
            self.menu.add_cascade(label="Rodar",menu=self.run)
            #code
            self.code_label=t.Label(self.compilerwindow,text="Codigo:",bg=self.color,font=("times new roman",15,"bold"),fg="#f2d53c")
            ...
            #input
            self.input_label=t.Label(self.compilerwindow,text="Entrada:",bg=self.color,font=("times new roman",15,"bold"),fg="#f2d53c")
            ...
            #output
            self.output_label=t.Label(self.compilerwindow,text="Saida:",bg=self.color,font=("times new roman",15,"bold"),fg="#f2d53c")
