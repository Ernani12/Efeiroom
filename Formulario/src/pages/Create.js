...
function Create(){
    ...
    return (
        <div>
            <h1 className="heading">Criar novo formulario</h1>
            
            <div className="form">
                <div className="input">
                    <label>Titulo do formulario</label>
                ...
                <div className="input">
                    <label>Validacao(Opcional)</label>
            ...
            <p className="mb-2 text-right">
                ...
                <button className="btn" onClick={createForm}>{ loading ? <span className="spinner white"></span> : <span>criar  formulario</span>}</button>
            </p>
            
            <div className="add-field-container grey-container">
                <p>Adicionar novo campo</p>
